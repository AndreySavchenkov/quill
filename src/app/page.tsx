...
export default function Home() {
  return (
    <>
      ...
      {/*Feature section */}
      <div className="mx-auto mb-32 bt-32 max-w-5xl sm:mt-56 ">
        <div className="mb-12 px-6 lg:px-6 ">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 ">Chatting to your PDF file has never ben easier than with Quill.</p>
          </div>
        </div>
      </div>
      ...
      <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
        <li className="md:flex-1">
          <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 mb:pb-0 mb:pl-0 md:pt-4">
